        ...
        <div class="feedback-form">
            ...
            <div class="user-info">
                ...
                <div class="name-input">
                    <input type="text" v-model="localFormData.userName" ref="inputRef" :disabled="isDisable">
                    <div class="clear-username" v-show="localFormData.userName" v-if="!isDisable">
            ...
            <div class="form-body">
                ...
                <div class="body-file">
                    <div class="file-list" :class="{ 'submit': isDisable }"
                        v-if="localFormData.attachments.length !== 0">
                        <div v-for="(file, index) in localFormData.attachments" :key="index" class="file-item">
                            <span>{{ file.name }}</span>
                            <button @click="removeFile(index)" class="remove-btn" v-if="!isDisable">
                                <i class="iconfont icon-close"></i>
                            </button>
                        </div>
                        <div class="add-clear-btn" v-if="!isDisable">
                ...
                <div class="body-content" :class="{ 'submit': isDisable }">
                    <div class="button-container" v-if="localFormData.content && !isDisable">
                    ...
                    <textarea v-model="localFormData.content" placeholder="请输入您的反馈内容..." @input="autoResize"
                        ref="feedbackTextarea" :disabled="isDisable"></textarea>
                </div>
            </div>
        </div>
